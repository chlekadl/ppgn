...
# Condition net
net_weights="nets/resnet/ResNet-50-model.caffemodel"
net_definition="nets/resnet/ResNet-50-deploy.prototxt"
#-----------------------

# Output dir
output_dir="output_resnet/${act_layer}_chain_${units}_eps1_${epsilon1}_eps3_${epsilon3}"
mkdir -p ${output_dir}
